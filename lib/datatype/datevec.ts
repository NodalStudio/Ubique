 ...
 *
 * @example Convert a date string to an array
 * ```ts
 ...
 * ```
 *
 * @example Convert an array of date strings to an array of arrays
 * ```ts
 * import { assertEquals } from "jsr:@std/assert";
 *
 ...
 * ```
 *
 * @example Convert a Unix timestamp to an array
 * ```ts
 * import { assertEquals } from "jsr:@std/assert";
 *
 ...
 * ```
 *
 * @example Convert an array of Unix timestamps to an array of arrays
 * ```ts
 * import { assertEquals } from "jsr:@std/assert";
 *
 ...
 * ```
 *
 * @example Convert a Unix timestamp with milliseconds to an array
 * ```ts
 * import { assertEquals } from "jsr:@std/assert";
 *
 ...
 * ```
 *
 * @example Convert a date string with time zone to an array (converts to UTC)
 * ```ts
 * import { assertEquals } from "jsr:@std/assert";
 *
 ...
 * ```
 *
 * @example Convert a date string in UTC format to an array
 * ```ts
 * import { assertEquals } from "jsr:@std/assert";
 *
 ...
 * ```
 *
 * @example Convert an array of mixed Unix timestamps and date strings to an array of arrays
 * ```ts
 * import { assertEquals } from "jsr:@std/assert";
 *
