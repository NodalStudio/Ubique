...
/**
 * @function ne
 * @summary Not equal comparison X ~= Y
 * @description Compares two inputs element-wise, returning true where elements in X are not equal to corresponding elements in Y.
 *
