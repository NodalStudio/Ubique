...
/**
 * @function le
 * @summary Less than or equal comparison X <= Y
 * @description Compares two inputs element-wise, returning true where elements in X are less than or equal to corresponding elements in Y.
 *
