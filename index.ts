...
export { isarray, isinteger, isstring, issingular, randchar, isfunction, datestr, clock, weekday, vectorfun, isundefined, ismatrix, isnumber, now, today, strfind, datevec, arrayfun, isempty, isscalar, month, datenum, isvector, isnull, islogical, lu, inv, linsolve, det, max, mean, mode, pdist, quartile, median, histc, mad, cov, range, zscore, varc, min, moment, corrcoef, std, prctile, xkurtosis, skewness, iqr, kurtosis, quantile, jbtest, norminv, normcdf, normpdf, interp1, linearreg, painratio, jensenalpha, annadjsharpe, trackerr, activereturn, twr, avgdrawdown, m2sortino, ulcerindex, toweekly, sterlingratio, calmarratio, cdrawdown, ror, drawdown, paramcondvar, painindex, martinratio, annreturn, annrisk, paramvar, ret2tick, sharpe, modigliani, percpos, omegaratio, inforatio, downsidepot, irr, hurst, montecarlovar, tomonthly, sortino, adjsharpe, tick2ret, burkeratio, histcondvar, upsidepot, cagr, mdietz, downsiderisk, histvar, treynor, ones, fix, reshape, logspace, getrow, fliplr, trues, flatten, squeeze, nrows, issquare, flipdim, subsetlin, vertcat, setrow, getcol, setcol, repmat, diag, horzcat, tomat, end, zeros, cat, size, rand, subset, eye, numel, falses, ndims, find, colon, ncols, transpose, clone, iscolumn, isrow, ind2sub, flipud, sort, linspace, sub2ind, length, mergesort, exp, log, erfc, erfinv, erfcinv, sign, abs, erf, sqrt, ceil, eq, cumprod, rem, gt, times, diff, cumsum, round, cumdev, floor, uminus, ne, power, prod, rdivide, mldivide, cummax, lt, mtimes, minus, cummin, mrdivide, ldivide, mod, le, ge, dot, plus, unique, sum, mpower };